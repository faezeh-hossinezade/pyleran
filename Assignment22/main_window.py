...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.task_table.setGeometry(QRect(40, 10, 701, 400))
        self.task_table.setMaximumSize(QSize(701, 16777215))
        self.task_table.setStyleSheet(u"background-color: rgb(216, 217, 255);\n"
"font: 700 12pt \"Vazir\";\n"
"color: rgb(0, 0, 255);\n"
"border-radius: 50%;")
        ...
        self.label_title.setStyleSheet(u"font: 300 12pt \"Vazir\";\n"
"background-color: rgb(255, 255, 127);")
        ...
        self.title_input.setStyleSheet(u"border-radius: 30%;\n"
"color: rgb(114, 113, 127);")
        self.label_description = QLabel(self.centralwidget)
        self.label_description.setObjectName(u"label_description")
        self.label_description.setGeometry(QRect(220, 420, 200, 20))
        self.label_description.setStyleSheet(u"font: 300 12pt \"Vazir\";\n"
"background-color: rgb(255, 255, 127);")
        ...
        self.description_input.setStyleSheet(u"border-radius: 30%;\n"
"color: rgb(114, 113, 127);")
        self.label_time = QLabel(self.centralwidget)
        self.label_time.setObjectName(u"label_time")
        self.label_time.setGeometry(QRect(580, 420, 161, 20))
        self.label_time.setStyleSheet(u"font: 300 12pt \"Vazir\";\n"
"background-color: rgb(255, 255, 127);\n"
"border-radius: 20%;")
        self.time_input = QDateTimeEdit(self.centralwidget)
        self.time_input.setObjectName(u"time_input")
        self.time_input.setGeometry(QRect(580, 440, 161, 31))
        self.time_input.setStyleSheet(u"border-radius: 40%;\n"
"color: rgb(114, 113, 127);")
        self.label_priority = QLabel(self.centralwidget)
        self.label_priority.setObjectName(u"label_priority")
        self.label_priority.setGeometry(QRect(430, 420, 141, 20))
        self.label_priority.setStyleSheet(u"font: 300 12pt \"Vazir\";\n"
"background-color: rgb(255, 255, 127);\n"
"border-radius: 50%;\n"
"")
        ...
        self.priority_input.setGeometry(QRect(430, 440, 141, 30))
        self.priority_input.setStyleSheet(u"border-radius: 30%;\n"
"color: rgb(114, 113, 127);")
        self.add_task_button = QPushButton(self.centralwidget)
        self.add_task_button.setObjectName(u"add_task_button")
        self.add_task_button.setGeometry(QRect(10, 480, 411, 30))
        self.add_task_button.setStyleSheet(u"font: 300 12pt \"Vazir\";\n"
"background-color: rgb(0, 85, 255);\n"
"color: rgb(255, 255, 255);\n"
"border-radius: 40%;")
        self.sort_tasks_button = QPushButton(self.centralwidget)
        self.sort_tasks_button.setObjectName(u"sort_tasks_button")
        self.sort_tasks_button.setGeometry(QRect(430, 480, 311, 30))
        self.sort_tasks_button.setStyleSheet(u"font: 300 12pt \"Vazir\";\n"
"background-color: rgb(0, 85, 255);\n"
"color: rgb(255, 255, 255);\n"
"border-radius: 40%;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.title_input.setText(QCoreApplication.translate("MainWindow", u"Enter New Title", None))
        ...
        self.description_input.setText(QCoreApplication.translate("MainWindow", u"Enter New Description", None))
