...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Load the UI elements from the designer tool generated class
        self.ui.setupUi(self)
        self.ui.time_input.setMinimumDate(QDate.currentDate())
        # Set minimum date for the time input to today's date
        self.ui.task_table.setColumnHidden(0, True)
        # Hide the first column (task ID) in the table
        ...
        # Create signal mappers for handling delete and details buttons (explained later)
        ...
        # Load initial data from the database (sorted by ID)
